...
<section data-aos="fade-up" data-aos-delay="100" class="modern-hero">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="./images/services/clearing.jpg" 
...
<section data-aos="fade-up" data-aos-delay="300" class="section-padding">
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-4">
                <!-- Image -->
                <img src="./images/services/clearing-1.jpg" class="img-fluid rounded-4" alt="Clearing & Forwarding" data-aos="fade-up" data-aos-delay="900">
                <img src="./images/services/clearing-2.jpg" class="img-fluid rounded-4 mt-4" alt="Clearing & Forwarding" data-aos="fade-up" data-aos-delay="900">
                <img src="./images/services/clearing-3.jpg" class="img-fluid rounded-4 mt-4" alt="Clearing & Forwarding" data-aos="fade-up" data-aos-delay="900">
            </div>
        </div>
    </div>
</section>
