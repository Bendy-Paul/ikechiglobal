...
<?php include_once('header.php'); ?>
    ...
    <section class="modern-hero" data-aos="fade-up" data-aos-delay="100">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <img src="https://placehold.co/600x400/1e2a38/f6b61b?text=Security+Solutions" 
    ...
    <section class="section-padding" data-aos="fade-up" data-aos-delay="120">
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-4">
                    <!-- Contact Widget -->
                    <div class="service-sidebar-widget" data-aos="fade-left" data-aos-delay="200">
                        <h4>Get In Touch</h4>
                        <p>Ready to secure your assets? Contact our security experts today for a consultation.</p>
                        <a href="contact.html" class="btn-modern w-100 text-center mt-3" data-aos="zoom-in" data-aos-delay="300">Contact Us</a>
                    </div>
                    
                    <!-- Image -->
                    <img src="./images/security.jpg" class="img-fluid rounded-4 mt-4" alt="Security Services" data-aos="fade-up" data-aos-delay="260">
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Services Section -->
    <section class="section-padding bg-light" data-aos="fade-up" data-aos-delay="140">
        <div class="container">
    ...
    <section class="modern-cta" data-aos="zoom-in" data-aos-delay="150">
        <div class="container">
            <div class="modern-cta-content">
                <h2 data-aos="fade-up" data-aos-delay="200">Ready to Secure Your Business?</h2>
                ...
                <a href="contact.html" class="btn-modern" data-aos="fade-up" data-aos-delay="320">Get Started Now</a>
            </div>
        </div>
    </section>
